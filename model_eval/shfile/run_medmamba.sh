...
WANDB_ENTITY="xxxxxxxxxxxxxx"  # Updated to match configuration
...
for dataset_name in "${DATASETS[@]}"; do
    ...
    # Train MedMamba models
    echo "Training MedMamba models..."
    for size in small base; do
        for lr in "${learning_rates[@]}"; do
            ...
            run_training "medmamba" $size "medmamba" $dataset_name \
